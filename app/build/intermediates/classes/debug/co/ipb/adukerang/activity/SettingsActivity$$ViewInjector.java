...
public class SettingsActivity$$ViewInjector<T extends co.ipb.adukerang.activity.SettingsActivity> implements Injector<T> {
  @Override public void inject(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131755237, "field 'txtUsername'");
    target.txtUsername = finder.castView(view, 2131755237, "field 'txtUsername'");
    view = finder.findRequiredView(source, 2131755238, "field 'txtEmail'");
    target.txtEmail = finder.castView(view, 2131755238, "field 'txtEmail'");
    view = finder.findRequiredView(source, 2131755239, "field 'txtPass0'");
    target.txtPass0 = finder.castView(view, 2131755239, "field 'txtPass0'");
    view = finder.findRequiredView(source, 2131755240, "field 'txtPass1'");
    target.txtPass1 = finder.castView(view, 2131755240, "field 'txtPass1'");
